...
### Speculative Next Items

- Add “near me” searches by distance so users can filter disasters by location, like within 50 miles of a city.
- Protect public use with basic rate limits and API keys so one person can’t spam the API or break the site.
